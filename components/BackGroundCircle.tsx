...
function BackGroundCircle() {
  return (
    ...
    >
      ...
      <div className='absolute border border-[#505050] rounded-full h-[300px] w-[300px] mt-52 ' />
      <div className='absolute border border-[#484848] rounded-full h-[500px] w-[500px] mt-52 ' />
